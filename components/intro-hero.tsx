...
import { introCards, OFFICE_NAME } from "@/lib/data";
    ...
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-600">
          Koncept internog sustava koji sažima upite, organizira dokumente, označava
          moguće rokove i priprema nacrte odgovora — bez davanja pravnih savjeta i
          bez slanja ičega bez odobrenja odvjetnice.
        </p>
